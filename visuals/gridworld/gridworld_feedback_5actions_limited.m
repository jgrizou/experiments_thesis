...
for iStep = 1:rec.nSteps
    ...
    % 5 is Noop
    if state == 1
        possibleAction = [3,2,5];
    elseif state == 2
        possibleAction = [3,2,1,5];
    elseif state == 3
        possibleAction = [3,1,5];
    elseif state == 4
        possibleAction = [3,4,2,5];
    elseif state == 5
        possibleAction = [3,4,2,1,5];
    elseif state == 6
        possibleAction = [3,4,1,5];
    elseif state == 7
        possibleAction = [4,2,5];
    elseif state == 8
        possibleAction = [4,2,1,5];
    elseif state == 9
        possibleAction = [4,1,5];
    end
