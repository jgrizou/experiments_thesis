...
h1 = shadedErrorBar(start:200, meandist(start:end,1,1), stddist(start:end,1,1), {'color', niceBlue}, 1);
h2 = shadedErrorBar(start:200, meandist(start:end,1,2), stddist(start:end,1,2), {'color', niceGray}, 1);
h3 = shadedErrorBar(start:200, meandist(start:end,1,3), stddist(start:end,1,3), {'color', niceGreen}, 1);
h4 = shadedErrorBar(start:200, meandist(start:end,1,4), stddist(start:end,1,4), {'color', niceOrange}, 1);
